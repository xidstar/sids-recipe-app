    ...
    <nav className="navbar">
      <div className="nav-center">
        ...
        <div className={show ? "nav-links show-links" : "nav-links"}>
          ...
          <Link to="/recipe" className="nav-link" activeClassName="active-link" onClick={() => setShow(false)}>Recipes</Link>
          ...
          <div className="nav-link contact-link">
            <Link to="/getintouch" className="btn" onClick={() => setShow(false)}>Contact</Link>
          </div>
        </div>
      </div>
    </nav>
